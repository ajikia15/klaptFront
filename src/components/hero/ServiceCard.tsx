...
export default function ServiceCard() {
  return (
    <div className="min-w-64 group relative aspect-[4/5] w-full cursor-pointer overflow-hidden rounded-xl bg-neutral-700">
      ...
      <div
        className={
          "pointer-events-none absolute inset-0 z-10 bg-gradient-to-t from-black/70 to-black/10 transition-all duration-500 ease-out group-hover:bg-black/60 group-hover:from-black/70 group-hover:to-black/10"
        }
      ...
      <div className="pointer-events-none absolute inset-0 z-20 flex h-full w-full flex-col opacity-0 transition-opacity duration-500 ease-out group-hover:pointer-events-auto group-hover:opacity-100">
